 ...
 */
function debugLocalFileHeader(buf, off) {
    let r = 0;
...
exports.debugLocalFileHeader = debugLocalFileHeader;
/*
...
+-------------------------------------+---------+
*/
function debugDataDescriptor(buf, off) {
    let r = 0;
...
exports.debugDataDescriptor = debugDataDescriptor;
/*
+--------------------------------------------+---------+
 ...
 * @returns New byte offset
 */
function debugCentralDirectory(buf, off) {
    let r = 0;
...
exports.debugCentralDirectory = debugCentralDirectory;
/*
+-------------------------------------------------------------------------------+---------+
 ...
 * @returns New byte offset
 */
function debugEndOfCentralDirectory(buf, off) {
    let r = 0;
...
exports.debugEndOfCentralDirectory = debugEndOfCentralDirectory;
/**
