 ...
 */
export function debugLocalFileHeader(buf, off) {
    let r = 0;
...
+-------------------------------------+---------+
*/
export function debugDataDescriptor(buf, off) {
    let r = 0;
 ...
 * @returns New byte offset
 */
export function debugCentralDirectory(buf, off) {
    let r = 0;
 ...
 * @returns New byte offset
 */
export function debugEndOfCentralDirectory(buf, off) {
    let r = 0;
